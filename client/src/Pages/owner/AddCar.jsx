...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add New Car" subTitle="Fill in details to list a new car for booking, included pricing, availabiity, and
         car specifications."/>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Year</label>
            <input type="number" placeholder="eg:2025" required
          ...
          <div className='flex flex-col w-full'>
            ...
            <input type="number" placeholder="eg:100" required
        ...
        {/*Car transmission, fuel type, seating capacity*/}
         ...
         <div className='flex flex-col w-full'>
           ...
           <select onChange={e=>setCar({...car,location: e.target.value})} value={car.location}
              ...
              <option value="">Select a location</option>
               ...
               <option value="Manual">Los Angeles</option>
               <option value="Diesel">Houston</option>
               <option value="Petrol">Chicago</option>
            </select>
         </div>
         ...
         {/*car description*/}
           <div className='flex flex-col w-full'>
            ...
            <textarea  rows={5} placeholder="eg: A luxuriour SUV with a spacious interior and a powerfull engine." required
