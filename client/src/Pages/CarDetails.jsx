      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <div className='lg:col-span-2'>
          ...
          <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
            {[
              ...
              { icon: assets.car_icon, text: car.transmission }, // fixed here
              { icon: assets.location_icon, text: car.location },
            ].map(({ icon, text }) => (
              <div key={text} className='flex flex-col items-center bg-light p-4 rounded-lg  bg-gray-100'>
        ...
        <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          ...
          {currency}{car.pricePerDay} <span className='text-base text-gray-400 font-normal'>per day</span>
           ...
           <p className='text-center text-sm'>No credit cards required to reserve</p>
